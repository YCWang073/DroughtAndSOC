...
LANDCOVER_CHANGE = xr.open_dataset(f"/mnt/softwares/Drought_And_SOC/001-1_land_use_data_TIFF/result/ssp370_land_cover_change.nc")['land_cover_change']
